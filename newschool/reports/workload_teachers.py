...
def calculate_statistic_teacher(date) -> pd.DataFrame:
    params = {
        "date": date,
        "includeRecords": "true",
    ...
    translate_columns = {
        ...
        "paid": "количество оплачиваемых посещений(включая пропущ. по не ув. причине)",
    ...
    return clean_data.rename(columns=translate_columns)
